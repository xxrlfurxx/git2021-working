...
public class TodoController {
	...
	private SortedMap<Long, Todo> todos = Collections.synchronizedSortedMap(
			new TreeMap<Long, Todo>(Collections.reverseOrder()));
	// id값 생성에 사용할 변수
	...
	public Todo modifyTodo(@PathVariable long id, @RequestBody Todo todo,
