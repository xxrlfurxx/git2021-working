...
// redux store(리덕스 저장소)에 하나의 state를 관리하고 처리할 수있는 모듈
...
export const profileSlice = createSlice({
    ...
    // initialState: initialState, // 이 slice의 초기값
...
// reducer 함수명에 맞는 action creator 들을 createSlice할 때 자동으로 생성함
...
// saveProfile(payload) => {type: "prpfile/saveProfile", payload}
